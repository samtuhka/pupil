...
cdef class Detector_3D:
    ...
    def init_gui(self,sidebar):
        ...
        advanced_controls_menu.append(ui.Slider('ellipse_roundness_ratio',self.detectProperties2D,label='Ellipse roundness ratio',min=0.1,max=1.0,step=0.01))
        advanced_controls_menu.append(ui.Slider('canny_ration',self.detectProperties2D,label='Canny ration',min=1,max=15,step=0.01))
        advanced_controls_menu.append(ui.Slider('canny_treshold',self.detectProperties2D,label='Canny treshold',min=100,max=300,step=1))
        advanced_controls_menu.append(ui.Slider('coarse_filter_min',self.detectProperties2D,label='Coarse filter min',min=100,max=200,step=1))
        advanced_controls_menu.append(ui.Slider('coarse_filter_max',self.detectProperties2D,label='Coarse filter max',min=250,max=350,step=1))
        self.menu2D.append(advanced_controls_menu)
